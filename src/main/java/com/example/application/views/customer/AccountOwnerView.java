...
//
//import com.example.application.data.entity.customers.AccountOwner;
...
//
//@PageTitle("Account Owners")
//@Route(value = "customers/owners", layout = MainLayout.class)
//@RouteAlias(value = "/customers/owners", layout = MainLayout.class)
//@RolesAllowed({ "Admin", "Superuser", "ADMIN" })
//@Uses(Icon.class)
public class AccountOwnerView  {
//extends AbstractPfdiView implements BeforeEnterObserver {
//
//	private static final long serialVersionUID = 2754507440441771890L;
//
//	private Grid<AccountOwner> grid = new Grid<>(AccountOwner.class, false);
//
...
//
//	@Autowired
//	public AccountOwnerView(CustomerTagService customerTagService, CustomerService customerService,
...
//				UI.getCurrent().navigate(AccountOwnerView.class);
...
//			refreshGrid();
//			event.forwardTo(AccountOwnerView.class);
//		}
//	}
//
