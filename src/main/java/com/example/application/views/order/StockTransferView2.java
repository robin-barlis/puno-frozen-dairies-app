...
@Uses(Icon.class)
public class StockTransferView2 extends VerticalLayout implements BeforeEnterObserver {
	...
	@Autowired
	public StockTransferView2(OrdersService ordersService, AuthenticatedUser user, DocumentTrackingNumberService documentTrackingNumberService) {
