...
@Route(value = "stockOrders", layout = MainLayout.class)
@RouteAlias(value = "/stockOrders", layout = MainLayout.class)
...
public class StockOrderView extends AbstractPfdiView implements BeforeEnterObserver {
	...
	@Autowired
	public StockOrderView(CustomerTagService customerTagService, CustomerService customerService,
		...
		createProfileDialog("Create Stock Order");
