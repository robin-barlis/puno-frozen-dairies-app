...
@Route(value = "order/deliveryReceipt/:id", layout = MainLayout.class)
@RouteAlias(value = "/order/deliveryReceipt/:id", layout = MainLayout.class)
@RolesAllowed({"Superuser", "Checker", "Sales", "CHECKER", "SALES" })
@Uses(Icon.class)
public class DeliveryReceiptView extends VerticalLayout implements BeforeEnterObserver {
