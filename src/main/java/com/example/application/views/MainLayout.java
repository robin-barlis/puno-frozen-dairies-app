...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("Puno Frozen Dairies");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Administration", "la la-columns", AdministrationView.class), //

                new MenuItemInfo("Products", "la la-th-list", ProductsView.class), //
